    ...
    const App = () => {
        ...
        // --- Checkout Logic ---
        const placeOrder = async (total, address, payment, items, paymentIntentId = null, paymentStatus = null) => {
            ...
            // Build the order payload (may include optional Stripe fields)
            const basePayload = {
                user_id: user.id,
                total_amount: total,
            ...
            try {
                ...
                handleNavigate('message', { message: 'Order placed successfully!', type: 'success' });
                return true;
            } catch (e) {
                handleNavigate('message', { message: e.message || 'Order failed.', type: 'error' });
                return false;
            }
        };
        ...
        return (
            <div className="h-screen bg-black text-white antialiased">
                ...
                {screen === 'login' && <LoginScreen onNavigate={handleNavigate} onLogin={() => {}} />}
                {screen === 'signup' && <SignupScreen onNavigate={handleNavigate} onSignup={() => {}} />}
